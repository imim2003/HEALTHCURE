...
--
-- Host: localhost
-- Generation Time: Feb 19, 2024 at 06:28 PM
...
('root', '[{\"db\":\"user\",\"table\":\"hospital\"},{\"db\":\"user\",\"table\":\"coolie\"},{\"db\":\"user\",\"table\":\"users\"},{\"db\":\"user\",\"table\":\"rating\"},{\"db\":\"user\",\"table\":\"books\"}]');
...
('root', 'user', 'coolie', '[]', '2024-02-03 20:28:45');
...
('root', '2024-02-19 17:18:00', '{\"Console\\/Mode\":\"show\",\"NavigationWidth\":0,\"lang\":\"en_GB\"}');
...
(3, 'e503392e-9741-11ee-a128-e6350eabd8de', 'nora', 'brij', 'doc', 10, 'sama', 'paracetamol', ' viral', '2023-12-12', '17:59:00', 100);
...
(7, 'sanskriti', 'san@gmail.com', 777666, 'BSB', 'sans@123', 657854899),
(8, 'a', 'a@b.com', 123121212, 'doc', 'hirao', 441154);
...
(2, 'ab', 123121211, 441155, 'abc12', 'ab@b.com');
...
(3, 'munawra', 'mun@gmail.com', '300980765', '239cfc3c-c2b3-11ee-acf2-e6350eabd8de'),
(4, 'nolo', 'nolo@polo.com', 'jolokolp', 'b4f7b91a-c2b8-11ee-acf2-e6350eabd8de'),
(5, 'nokochan', 'chan@japan.com', 'japaapj', '48f4759a-c2b9-11ee-acf2-e6350eabd8de'),
(6, 'nokochan', 'chan@japan.com', '6yuoooo', '5fa176ee-c2b9-11ee-acf2-e6350eabd8de'),
(7, 'bololo', 'loa@bop.com', 'bjiuy', '825098ea-c2ba-11ee-acf2-e6350eabd8de'),
(8, 'volp', 'volp@gmail.com', '56432er', '551d3efc-c2c2-11ee-acf2-e6350eabd8de');
